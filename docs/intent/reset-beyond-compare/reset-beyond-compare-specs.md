...
- [ ] **BCOMPARE-004**: If the registry key or its `CacheID` value does not exist, then the system shall report a clear, guarded message rather than a raw non-terminating error.
